#!python
from utils import download_wasmer, download_wasmtime, WASMER_VER_DEFAULT, WASMTIME_VER_DEFAULT, WAMR_DEFINES
...
if env["wasm_runtime"] != "wamr":
    ...
    source += [env.Glob("wamr/src/*.c"), "wamr/stub.c"]
    env.Append(CPPDEFINES=WAMR_DEFINES)
