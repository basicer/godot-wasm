...
#include "wasm_opcode.h" // wasm_opcode.h
#include "wasm_loader.h" // wasm_loader.h
#include "wasm_memory.h" // wasm_memory.h
#include "wasm_exec_env.h" // ../common/wasm_exec_env.h
#if WASM_ENABLE_GC != 0

#include "mem_alloc.h" // mem_alloc.h
#if WASM_ENABLE_STRINGREF != 0
#include "string_object.h" // string_object.h
#endif
#endif


#if WASM_ENABLE_SIMDE != 0
#include "simd128.h" // simde/wasm/simd128.h
#endif
